...
//    }
    ...
    while ([NSStringFromClass(superClass) containsString:@"NSKVONotifying"]) {
...
//    objc_msgSendSuper(&superclazz, _cmd, newValue);  这样写就会崩溃
...
//    Class class_obj = object_getClass(self);
    ...
    if (![self hasSelector:setterSelector]) {
        ...
        class_addMethod(class_obj, setterSelector, setter, types);
    }
